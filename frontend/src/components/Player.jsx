  ...
  return (
    <div>
      ...
      <div className="columns-2 mt-1 mb-0 sm:flex flex-col bg-green-800 items-center justify-center backdrop-filter backdrop-blur-3xl bg-opacity-40 rounded-lg border-8 border-double border-green-900 min-h-[30vh] max-w-[60vh] max-h-[50vh] min-w-[70vh] p-4 sm:min-h-[90vh] sm:max-w-[50vh] sm:max-h-[100vh] sm:min-w-[50vh]">
        <img src={image} className="rounded-full w-4/5 mt-7" alt={name} />
        ...
        <div className="uppercase mt-2 ml-2 border-green-800 w-1/2 p-2 text-center pb-3 flex justify-center items-center sm:border-b-4 ">
          <img
            src={heartImg}
            alt="Heart"
        ...
        <div className="border-l-8 sm:border-l-0 ml-0 border-green-900 uppercase mt-2 flex justify-center p-2 items-center">
